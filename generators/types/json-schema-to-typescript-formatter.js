...
function parseJson2Ts(jsonSchema, typeName, extendsFrom, embeddedWithin) {
    return __awaiter(this, void 0, void 0, function* () {
        let typeDef = (yield json_schema_to_typescript_1.compile(jsonSchema, typeName)).replace(exports.jsonSchema2TsAutoGeneratedText, "");
        if (extendsFrom) {
            typeDef = appendInterfaceExtension(typeDef, extendsFrom);
        }
        if (embeddedWithin) {
            typeDef = nestContentIntoProperty(typeDef, embeddedWithin);
        }
        return typeDef;
    });
}
