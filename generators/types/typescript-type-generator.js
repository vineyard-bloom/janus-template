...
function mapEndpointDefinitionsToTypeDefs(endpointDefinitions) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Promise.all(endpointDefinitions.map((endpointDef) => __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                requestTsDef: yield json_schema_to_typescript_formatter_1.parseJson2Ts(request, requestTypeName, "Request", "data"),
                responseTsDef: yield json_schema_to_typescript_formatter_1.parseJson2Ts(response, responseTypeName),
                title: title
            };
        })));
    });
