...
function configureJsonSchemaGeneration(targetDirectory, sourceDirectory, schemaDefinitionsJSON) {
    ...
    const apiActionsWriter = new api_contract_writer_1.ApiContractWriter(apiContractFile, endpointTypesFile);
    return {
        endpointDefinitions,
        rawSchema,
        compileAll: () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield apiActionsWriter.writeApiContract(endpointDefinitions);
